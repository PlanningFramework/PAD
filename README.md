...
**PAD Framework** is an open source planning framework under **GNU GPL** license.
...
**PAD Framework** consists of 4 primary **projects**:
  ...
  * **PAD.Launcher** -- provides components for automated parallel execution of planning task batches, allowing parametrized definition of planning tasks via configuration file,
