...
(:requirements :typing :negative-preconditions :conditional-effects :action-costs :equality) ; PAD Framework: added :action-costs and :equality requirements, otherwise the domain definition violates the PDDL specification
(:types
