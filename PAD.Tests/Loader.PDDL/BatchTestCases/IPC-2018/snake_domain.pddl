(define (domain snake)
(:requirements :strips :negative-preconditions :equality) ; PAD Framework: added :equality requirement, otherwise the domain definition violates the PDDL specification
(:constants
    dummypoint
)
(:predicates
