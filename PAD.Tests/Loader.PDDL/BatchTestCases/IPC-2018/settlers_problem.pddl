;; Generator input: seed=310679, locations=16, edges=18, seas=2, probabilities=[2, 3, 3, 4], goals=8, optimization=[5, 10], C=1.500000, V=1.500000
(define (problem psat-huge-08-medium)
(:domain settlers)
(:objects
    ...
    cl11 cl12 cl13 cl14 cl15 cl16 cl17 cl18 cl19 cl20 cl21 cl22 cl23 cl24 cl25 cl26 cl27 cl28 cl29 cl30 cl31 cl32 cl33 cl34 cl35 cl36 - coal_level
    wl11 wl12 wl13 wl14 wl15 wl16 wl17 wl18 wl19 wl20 wl21 wl22 wl23 wl24 wl25 wl26 wl27 wl28 wl29 wl30 wl31 wl32 wl33 wl34 wl35 wl36 - wood_level
    il11 - iron_level
    ol11 - ore_level
    tl11 tl12 tl13 tl14 tl15 tl16 tl17 tl18 tl19 tl20 tl21 tl22 tl23 tl24 tl25 tl26 tl27 tl28 tl29 tl30 tl31 tl32 tl33 tl34 tl35 tl36 - timber_level
)
(:init
    ...
    (CONNECTED-BY-LAND p1 p8)
    (CONNECTED-BY-LAND p1 p10)
    (CONNECTED-BY-LAND p1 p11)
    (CONNECTED-BY-LAND p2 p6)
    (CONNECTED-BY-LAND p2 p7)
    (CONNECTED-BY-LAND p3 p4)
    (CONNECTED-BY-LAND p3 p6)
    (CONNECTED-BY-LAND p4 p3)
    (CONNECTED-BY-LAND p4 p8)
    (CONNECTED-BY-LAND p5 p0)
    (CONNECTED-BY-LAND p5 p1)
    (CONNECTED-BY-LAND p6 p2)
    (CONNECTED-BY-LAND p6 p3)
    (CONNECTED-BY-LAND p6 p8)
    (CONNECTED-BY-LAND p6 p12)
    (CONNECTED-BY-LAND p7 p0)
    (CONNECTED-BY-LAND p7 p2)
    (CONNECTED-BY-LAND p7 p11)
    (CONNECTED-BY-LAND p7 p13)
    (CONNECTED-BY-LAND p8 p1)
    (CONNECTED-BY-LAND p8 p4)
    (CONNECTED-BY-LAND p8 p6)
    (CONNECTED-BY-LAND p8 p10)
    (CONNECTED-BY-LAND p9 p10)
    (CONNECTED-BY-LAND p10 p1)
    (CONNECTED-BY-LAND p10 p8)
    (CONNECTED-BY-LAND p10 p9)
    (CONNECTED-BY-LAND p11 p1)
    (CONNECTED-BY-LAND p11 p7)
    (CONNECTED-BY-LAND p12 p6)
    (CONNECTED-BY-LAND p13 p7)
    (CONNECTED-BY-SEA p1 p5)
    (CONNECTED-BY-SEA p1 p6)
    (CONNECTED-BY-SEA p1 p12)
    (CONNECTED-BY-SEA p5 p1)
    (CONNECTED-BY-SEA p5 p6)
    (CONNECTED-BY-SEA p5 p12)
    (CONNECTED-BY-SEA p6 p1)
    (CONNECTED-BY-SEA p6 p5)
    (CONNECTED-BY-SEA p6 p12)
    (CONNECTED-BY-SEA p12 p1)
    (CONNECTED-BY-SEA p12 p5)
    (CONNECTED-BY-SEA p12 p6)
    (CONNECTED-BY-SEA p2 p9)
    (CONNECTED-BY-SEA p2 p10)
    (CONNECTED-BY-SEA p2 p11)
    (CONNECTED-BY-SEA p2 p13)
    (CONNECTED-BY-SEA p2 p14)
    (CONNECTED-BY-SEA p2 p15)
    (CONNECTED-BY-SEA p9 p2)
    (CONNECTED-BY-SEA p9 p10)
    (CONNECTED-BY-SEA p9 p11)
    (CONNECTED-BY-SEA p9 p13)
    (CONNECTED-BY-SEA p9 p14)
    (CONNECTED-BY-SEA p9 p15)
    (CONNECTED-BY-SEA p10 p2)
    (CONNECTED-BY-SEA p10 p9)
    (CONNECTED-BY-SEA p10 p11)
    (CONNECTED-BY-SEA p10 p13)
    (CONNECTED-BY-SEA p10 p14)
    (CONNECTED-BY-SEA p10 p15)
    (CONNECTED-BY-SEA p11 p2)
    (CONNECTED-BY-SEA p11 p9)
    (CONNECTED-BY-SEA p11 p10)
    (CONNECTED-BY-SEA p11 p13)
    (CONNECTED-BY-SEA p11 p14)
    (CONNECTED-BY-SEA p11 p15)
    (CONNECTED-BY-SEA p13 p2)
    (CONNECTED-BY-SEA p13 p9)
    (CONNECTED-BY-SEA p13 p10)
    (CONNECTED-BY-SEA p13 p11)
    (CONNECTED-BY-SEA p13 p14)
    (CONNECTED-BY-SEA p13 p15)
    (CONNECTED-BY-SEA p14 p2)
    (CONNECTED-BY-SEA p14 p9)
    (CONNECTED-BY-SEA p14 p10)
    (CONNECTED-BY-SEA p14 p11)
    (CONNECTED-BY-SEA p14 p13)
    (CONNECTED-BY-SEA p14 p15)
    (CONNECTED-BY-SEA p15 p2)
    (CONNECTED-BY-SEA p15 p9)
    (CONNECTED-BY-SEA p15 p10)
    (CONNECTED-BY-SEA p15 p11)
    (CONNECTED-BY-SEA p15 p13)
    (CONNECTED-BY-SEA p15 p14)
    (BY-COAST p1)
    (BY-COAST p2)
    (BY-COAST p5)
    (BY-COAST p6)
...
(and
    (has-ironworks p5)
    (connected-by-rail p2 p6)
    (connected-by-rail p6 p3)
    (connected-by-rail p2 p7)
    (connected-by-rail p10 p9)
    (housing p10 hl1)
    (housing p13 hl1)
    (housing p7 hl1)
)
