...
; PAD Framework edits: errors in the original file - ":quanitfied-precondition" misspell and missing other requirements
;                                                  - invalid comma characters in predicate uses
...
(define (domain fridge-domain)
  (:requirements :strips :typing :quantified-preconditions :adl)
