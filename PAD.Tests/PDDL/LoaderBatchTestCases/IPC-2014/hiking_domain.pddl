...
(define (domain hiking)
  (:requirements :strips :equality :typing :negative-preconditions) ; PAD Framework: added :negative-preconditions requirement, otherwise the domain definition violates the PDDL specification
