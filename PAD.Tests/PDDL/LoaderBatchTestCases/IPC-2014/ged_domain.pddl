...
(:requirements :equality :action-costs :negative-preconditions) ; PAD Framework: added :negative-preconditions requirement, otherwise the domain definition violates the PDDL specification
  (:predicates
