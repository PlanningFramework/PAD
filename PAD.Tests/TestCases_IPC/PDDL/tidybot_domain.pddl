...
(define (domain TIDYBOT)
  (:requirements :strips :typing :equality :negative-preconditions) ; PAD Framework: added :negative-preconditions requirement, otherwise the domain definition violates the PDDL specification
