...
{
    /// <summary>
    /// Logical 'forall' expression.
    /// </summary>
    public class ForallExpression : IExpression
    {
        /// <summary>
        ...
        public ForallExpression(Parameters parameters, IExpression child)
        {
        ...
        {
            return $"(forall {Parameters} {Child})";
        }
        ...
        {
            ForallExpression other = obj as ForallExpression;
            if (other == null)
            {
                return false;
            }
        ...
        {
            return new ForallExpression(Parameters.Clone(), Child.Clone());
        }
