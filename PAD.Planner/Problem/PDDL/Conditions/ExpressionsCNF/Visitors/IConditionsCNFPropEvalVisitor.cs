...
namespace PAD.Planner.PDDL
{
    ...
    public interface IConditionsCNFPropEvalVisitor
    {
        ...
        Tuple<double, double> Visit(ConditionsCNF expression);
        ...
        /// <returns>Tuple (property satisfied count, property not satisfied count).</returns>
        Tuple<double, double> Visit(ClauseCNF expression);
        ...
        /// <returns>Tuple (property satisfied count, property not satisfied count).</returns>
        Tuple<double, double> Visit(PredicateLiteralCNF expression);
        ...
        /// <returns>Tuple (property satisfied count, property not satisfied count).</returns>
        Tuple<double, double> Visit(EqualsLiteralCNF expression);
        ...
        /// <returns>Tuple (property satisfied count, property not satisfied count).</returns>
        Tuple<double, double> Visit(NumericCompareLiteralCNF expression);
    }
}
