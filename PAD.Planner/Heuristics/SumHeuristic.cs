...
{
    /// <summary>
    /// Implementation of a sum heuristic. A given list of heuristics is evaluated, and the sum of the heuristic values is returned.
    /// </summary>
    public class SumHeuristic : Heuristic
    {
        ...
        public SumHeuristic(IEnumerable<IHeuristic> heuristics) : base(null)
        {
        ...
        /// </summary>
        /// <param name="heuristics">List of heuristics.</param>
        public SumHeuristic(params IHeuristic[] heuristics) : base(null)
        {
            Heuristics = heuristics;
        }
        ...
        {
            return Heuristics.Sum(heuristic => heuristic.GetValue(state));
        }
        ...
        {
            return Heuristics.Sum(heuristic => heuristic.GetValue(conditions));
        }
        ...
        {
            return $"Sum Heuristic of ({string.Join(", ", Heuristics.Select(heuristic => heuristic.GetName()))})";
        }
    }
}
