...
{
    /// <summary>
    /// Implementation of a non-generic version of simple stack.
    /// </summary>
    public class SimpleStack : SimpleStack<ISearchNode>, IHeap
    {
    }

    /// <summary>
    /// Implementation of a simple stack (not actually a heap, for special usage).
    /// </summary>
    /// <typeparam name="Value">Value type.</typeparam>
    public class SimpleStack<Value> : IHeap<double, Value>
    {
        /// <summary>
